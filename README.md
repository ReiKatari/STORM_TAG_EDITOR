...
<img src="logo.png" width="128" height="128" alt="STORM TAG EDITOR Logo" />

# ⚡ STORM TAG EDITOR

<p align="center">
  <b>Редактор ID3 и аудио-тегов, пакетное переименование треков и интеграция обложек.</b>
</p>

[![Version](https://img.shields.io/badge/version-1.2.1-00D2FF.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_TAG_EDITOR)
[![Platform](https://img.shields.io/badge/Platform-Windows%2011%20%7C%2010-0EA5E9.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_TAG_EDITOR)
...
**STORM TAG EDITOR** — компонент программного комплекса **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
...
1. Запустите файл STORM_STORM_TAG_EDITOR_1.2.1_Setup.exe.
2. Выберите режим:
   * **Стандартная установка** — установка в C:\Program Files\STORM TAG EDITOR с созданием ярлыков и регистрацией в системе.
